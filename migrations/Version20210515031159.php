 ...
 */
final class Version20210515031159 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE sensorConfiguration (id INT AUTO_INCREMENT NOT NULL, config_key VARCHAR(200) NOT NULL, config_value VARCHAR(50) DEFAULT NULL, config_date DATE NOT NULL, config_type VARCHAR(25) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
