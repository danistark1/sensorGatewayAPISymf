 ...
 */
final class Version20210417233137 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE weatherConfiguration (id INT AUTO_INCREMENT NOT NULL, config_key VARCHAR(200) NOT NULL, config_value VARCHAR(50) DEFAULT NULL, config_date DATE NOT NULL, config_type VARCHAR(25) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE weatherReport (id INT AUTO_INCREMENT NOT NULL, email_body LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', last_sent_date DATE DEFAULT NULL, last_sent_time TIME DEFAULT NULL, last_sent_counter INT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    }
