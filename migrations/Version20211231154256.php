 ...
 */
final class Version20211231154256 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE sensorHistoricReadings (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(100) NOT NULL, lowest_reading INT DEFAULT NULL, highest_reading INT DEFAULT NULL, type VARCHAR(100) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
